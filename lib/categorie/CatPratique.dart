...
class CatPratique extends StatefulWidget {
  final String description;
  const CatPratique({super.key, required this.description});

  @override
  State<CatPratique> createState() => _CatPratiqueState();
}

class _CatPratiqueState extends State<CatPratique> {
  int _IndexSelect = 0;
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('tickets')
            .where('category', isEqualTo: 'PRATIQUE')
            .snapshots(),
